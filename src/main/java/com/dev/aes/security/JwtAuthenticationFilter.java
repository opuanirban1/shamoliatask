...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void setServerProperties(HttpServletRequest request){
        if (localServerProperties.getLocalServerURL() == null) {
            String currentRequestURL = request.getRequestURL().toString();
            String contextPath = request.getRequestURI();
            String localServerURL = currentRequestURL.substring(0, currentRequestURL.indexOf(contextPath));
            localServerProperties.setLocalServerURL(localServerURL);
        }
    }
}
